...
public class genratePDF {
    ...
    public static void generate(String name) throws FileNotFoundException, DocumentException{
    ...
    PdfPCell TopLeftLabel = new PdfPCell();
    ...
    PdfPCell leftheader = new PdfPCell(topleftheader);
